...
public class StripeService {
    ...
    public StripeChargeDto charge(StripeChargeDto chargeRequest, Pedido pedido) {
        try {
            ...
            String info = " pedido " + pedido.getNumero() + " - Usuario: ID  " + pedido.getUsuario().getId()
            ...
            // Manejar la excepción si la cadena de la cantidad no tiene un formato numérico
            // válido
            log.error("Formato de cantidad no válido", e);
            // Puedes devolver una respuesta indicando que el formato de la cantidad no es
            // válido
